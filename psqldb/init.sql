...
INSERT INTO users
  (name,email,username,password,sheet_id)
VALUES
  ('test', 'test@gmail.com', 'test', 'test', 'test');
INSERT INTO users
  (name,email,username,password,sheet_id)
VALUES
  ('syune', 'syune@gmail.com', 'syune', '123456', 'test');
INSERT INTO users
  (name,email,username,password,sheet_id)
VALUES
  ('king111', 'king111@gmail.com', 'king111', '123456', 'test');
INSERT INTO users
  (name,email,username,password,sheet_id)
VALUES
  ('kingusha', 'kingusha@gmail.com', 'kingusha', '123456', 'test');
...
ALTER TABLE predictions ALTER COLUMN is_bet
SET
DEFAULT false;
INSERT INTO predictions
  (text,author,country,league,teams,title,match_date)
VALUES
  ('Barcelona wins easily', 'king111', 'Spain', 'La Liga', 'Barcelona vs Real Madrid', 'Barcelona wins easily', '07.09.2019');
CREATE TABLE bets
(
  id SERIAL UNIQUE,
  username VARCHAR(50),
...
ALTER TABLE bets ALTER COLUMN is_prediction
SET
DEFAULT false;
CREATE TABLE likes
(
